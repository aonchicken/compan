...
from .views import DemoPDFView, PDFUserDetailView,PDF_View
...
urlpatterns = [
    ...
    url(r'^doc_pdf/',login_required(GeneratePdf.as_view()),name = "doc_pdf"),
    url(r'^doc_pdf2/', views.doc_pdf2, name="doc_pdf2"),
    url(r'^pdf/', PDFView.as_view(inline=True,template_name='doc_pdf.html'),name='pdf'),
    ...
    #url(r'^my-pdf/$', views.view_pdf, name='my-pdf'),
    #url(r'^hello_pdf/$', DemoPDFView.as_view(), name='hello-pdf'),
